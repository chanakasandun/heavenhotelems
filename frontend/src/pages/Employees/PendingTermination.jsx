...
export default function PendingTermination() {
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Container>
                    ...
                    {filteredRows
                      ...
                      .map((row) => (
                        <TableRow hover tabIndex={-1} key={row.id}>
                          ...
                          <TableCell>2024-16-15</TableCell>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Are you sure you want to reject this termination?
              </DialogContentText>
            </DialogContent>
            <DialogActions>
          ...
          >
            ...
            <DialogContent>
              <DialogContentText id="alert-dialog-description">
                Are you sure you want to approve this termination?
              </DialogContentText>
            </DialogContent>
            <DialogActions>
