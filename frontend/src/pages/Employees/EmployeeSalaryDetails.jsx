...
const rows = [
  {
    ...
    total_allowance: "45,000.00",
    total_salary: "145,000.00"
  },
  {
    salary_id: "",
    id: "2",
...
export default function EmployeeeSalaryDetails() {
  ...
  const handleOpenEdit = (row) => {
    ...
    setBasic(row.basic_salary)
    setAllowance(row.total_allowance)
    setOpenEdit(true);
  };
  ...
  const [basicSalaryEdit, setBasic] = React.useState('');
      
  const handleBasicSalaryChange = (event) => {
    setBasic(event.target.value);
  };

  const [allowanceEdit, setAllowance] = React.useState('');
      
  const handleAllowanceEdit = (event) => {
      ...
      <Box sx={{ display: "flex" }}>
        ...
        <Container>
                    ...
                    {filteredRows
                      ...
                      .map((row) => (
                        <TableRow hover tabIndex={-1} key={row.id}>
                          ...
                          <TableCell>{row.total_allowance}</TableCell>
          ...
          <Dialog
            ...
            >
              <DialogTitle align="center" sx={{ fontSize: '18px'}}>Edit Employee Salary Details</DialogTitle>
              <DialogContent>
                <TextField
                  fullWidth
                  label="Employee"
