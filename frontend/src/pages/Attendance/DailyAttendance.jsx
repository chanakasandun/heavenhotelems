...
function createData(id, employee, start, end) {
  return {
    id,
    employee,
    start,
...
const rows = [
  createData('HH0001', 'H E Fernando', '2024-12-10 08:30:00', '2024-12-10 18:30:00'),
  createData('HH0002', 'H E Fernando', '2024-12-10 08:25:00', '2024-12-10 17:30:00'),
];
          ...
          <DialogContent>
            ...
            <FormControl fullWidth sx={{paddingBottom: '15px'}}>
              ...
              >
                ...
                <MenuItem value={1}>HH0001 - Pasindu Madushka</MenuItem>
              </Select>
            </FormControl>
            <TextField
              fullWidth
