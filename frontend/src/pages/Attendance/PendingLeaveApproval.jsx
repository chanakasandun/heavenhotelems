...
function createData(id, employee, leave, start, end, days) {
  return {
    id,
    employee,
    leave,
...
const rows = [
  createData('HH0001', 'H E Fernando','Casual', '2024-12-05', '2024-12-05', 1),
  createData('HH0002', 'H E Fernando', 'Annual','2024-12-10', '2024-12-15', 5),
];
...
export default function PendingLeaveApproval() {
